...
<head>
  ...
  <title>Agen Properti | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Agen Properti </b>XYZ</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="../proses/RegistrasiProses.php">
        ...
        <div class="input-group mb-3">
          <input type="password" name="konfirmasipassword" id="konfirmasipassword" class="form-control" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
